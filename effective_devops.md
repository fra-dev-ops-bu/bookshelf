...
**サポートローテーション**は他チームのメンバーが顧客サポートにまわり、サポート業務を理解しつつ負担を減少させる方法である。 **エンジニア交換**は異なる企業間でエンジニアを交換することである。企業の秘密を守ることより、ソフトウェアや働き方のオープンソース化によって業界全体を強化し、知識や経験を共有交換することができる。

ただしこれらの交換は双方向的な共有が必要である他、コモンズの悲劇を引き起こす非協力的な組織が居てはならない。
