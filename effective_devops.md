...
同僚との間のコラボレーション---対話、教育、支援

### 7.1 Sparkle Corpの週次プランニングミーティングにて

意見の違い。どう解決する？
コラボレーションの仕方によって、共同体は強くもなるし、弱くもなる。
7.10 で解説されている

### 7.2 コラボレーションの定義
パフォーマンスが高いチームには、次のような特徴があることがわかっている:
- コミュニケーション
- 平等な参加
- 心の理論
心の理論とは、考え方の違う他者を尊重すること。
...
キャリアへの考え方、スキルアップの内容、外部との関わり方など
...
- メンターシップ: 若手の育成
- スポンサーシップ: キャリア形成支援
- 教育: スキルを身に着けさせると、良いポジションに着くために会社から離れてしまうという懸念がある。しかし実際は逆だ。
...
#### 7.6.2 固定思考
「だめなやつは何をやってもだめ」と思っていないか？そんなことはない！

#### 7.6.3 成長思考
失敗を恐れず、リスクを取り、大きく成長せよ。
...
理解の深化、影響力の行使、感謝の表明、コミュニティの構築

#### 7.10.2 コミュニケーションの形
コミュニケーションの手段、交渉や対立解決のスタイル

#### 7.10.3 コミュニケーションのコンテキストと権力関係
ジョークなどのTPO、リモートワークのメンバーへの配慮、性別、人種、性的嗜好などを含む権力関係
