...
> アフィニティ(親近感、一体感)とは、チーム間の関係を構築し、共感を育て、他のチームの人たちからも学習するプロセスである


### 9.1 Sparkle Corpの開発デモの日

アリスとジョーディーはMongoDBとMySQLを比較するマシンを作成し、会議に提示した。Sparkle Corpは
- MySQLを使い続ける
- MongoDBを使うために運用チームと共同で調査をする
- 顧客が何を求めているか詳しいProject Managerに判断を仰ぐ
などの様々な選択肢を取ることが出来る。
...
- 人の結びつきは３種類（強・弱・無）
- 弱い結びつきを育てることで大きな利益を生み出せる
- 結びつきを利用して仕事の関係を強化させる方法を以下で紹介
...
アフィニティは、適材適所な人選と、多チームや組織と関係を構築することである。devops共同体の維持のためには、効果的な協力の実現が重要となる。そのためにはチーム間の関係を構築したり破壊する人間的な要素を検討することが必要である。
...
##### 9.3.5.1 内集団・外集団理論
外敵を作ることで内部の団結力が高まる理論を **内集団/外集団理論** と呼ぶ。
- 内集団における仲間意識や平和
- 外集団に対する敵意や争い
- 小さな集団ほど似ている人が集まるため、団結力は強まる
- 通常時は関係のない人を集める（敵の敵は味方理論）

このような理論はdevとopsの対立を生む切っ掛けになる。
- 上層部と現場の対立
- 開発者と運用の対立

対立の回避には以下が有効である。
- **経験の共有** は、信頼を構築し対立リスクを軽減させる
- **交差カテゴリ化** は、他グループの業務を経験させることで外集団への偏見を低減させる

##### 9.3.5.2 グループのメンバーの多様性

チームメンバーで全ての多様性を網羅するようにそろえることはとてもできない。その場合、ソフトウェアが提供するソリューションやポリシーに対して不利益を受けるグループが存在する可能性がある。
- 例：SNSにおける実名義務など → DVや差別を受けている場合、大きな不利益とリスクをもたらす
...
インターセクショナリティは様々な抑圧や差別と、その結びつきを研究する学問である。多様性は常に達成し続ける必要があり、それにより開放性の確保によって生活性、生産性が向上する、という意識を持つ必要がある。
...
- 多様性を意識するあまり、他のメンバーとの違いに注意を集めさせるようなことはしてはならない
- 多様性に関わるメンバーだからといって多様なグループを代弁するわけではないため、負担をかけすぎない
- オプトイン活動とオプトアウト活動について
  - オプトイン活動は参加選択制の活動であり、参加をためらうような壁をつくらないように注意すべきである
  - オプトアウト活動は基本参加の活動であり、参加した際に疎外感を受けないように注意する必要がある

開放性のある環境を整備するために以下のことを念頭におくべきである
- リクルーターに企業の多様性と開放性を意識させる
- 無意識の偏見についてのトレーニングをさせる
- ロールモデルを示し、問題のある言動を非難し、一部メンバーだけの責任にしない
- 社員グループを立ち上げ、様々な支援を行う
- 作業環境を監査し、必要最低限以上の環境を与える
- 求人票の多様性維持のために有償の査読を通す
- 自らの言動が差別的にならないよう注意を払う
- 多様性のある人材の採用以前から多様性に開放的な環境を作る

### 9.4 チームと組織構造

安定した関係を結べる相手の上限は150人程度（ダンバー数）であるため、それ以上の人数が集団に所属すると、規則や法律などの規範が必要となる。大きな組織では文化的プラクティスを通して社会構造を構築する必要がある。個人間、グループ間の関係を重視できない場合、不必要な競争や排他的な行動を導く。

### 9.5 チーム間で共通な地盤を見つける
異なるチーム間の隙間には様々な問題がある。
- **目的の違い** 迅速な新機能の提供 vs 頑健なサービス維持
- **効果測定** コード数評価 vs バグ発見数評価によるコード質と迅速性の低下
- **リーダーシップの違い** マイクロマネジメント vs ハンズオンスタイルによる極端な管理と挑戦を推進するリーダーによるリーダー間の対立
- **コミュニケーションスタイルの違い** 同質的な人たちによる一体化したチームは、多文化のチームと対立を導く

#### 9.5.1 競争から協調へ
チームが競争関係から協力し合う関係へ移ることが重要であるため、協力的な職場環境の構築と維持が必要である。ここではゲーム理論の側面を用いて方法を紹介する。
- 公平な競争は創造性を高め、顧客に選択肢を与えながら自由市場を構築する。
- 競争の激化は**コモンズの悲劇** を誘発し、個人が利益のために独立して行動することで共有リソースを枯渇させ、全体の利益を低下せる。
- **E.オストロム**がステークホルダーや集団行動、相互採用の側面からコモンズシナリオの成功を導く要素を定義した。
  - 集団全体の成因をコントロールする手段
  - 社会ネットワーク
  - 参加するすべての人の行動の観察可能性
  - 個人に対する段階的な制裁
...
協力的なコミュニティの構築には、オストロムの理論を確保する必要がある。適切な制裁行動は一部の非難されるべき行動を抑制し、コミュニティを公正なものへと動かす。スタートアップ、または急激に業績が悪化し縮小している会社などはリソースの変化が激しくなりうる場合があるため、非協力的な行動を誘発しやすい。

#### 9.5.2 チームの共感を築く
> devops運動の重要な教義のひとつは、壁の向こうにいる人たち、つまり企業の別の部門の人たちに対する共感だけでなく、顧客に対する共感も育てることである。(p.125)

##### 9.5.2.1 指名運用エンジニア
サイロ化環境では、チーム間のサポートやサービスの提供が困難である。他チームのための担当運用エンジニアを指定することで、チーム間が繋がる。ランダムにサポートエンジニアを振り分けないことで、最初から全ての説明引継ぎを行う必要が無く、開発も運用も首尾一貫したものとなる。

指名運用エンジニアの機能には以下のようなポイントを考慮する必要がある。
- **指名されているが専任ではない** 指名運用エンジニアはチームの連絡先になることであり、自分の仕事をしながら関連する仕事の管理や監督を行う。
- **運用チームの規模** 運用チームが大きくないと仕事の負担が大きくなるため、小さな運用チームでは成功しない。
- **開放性の確保** 運用は感謝されにくく、トラブル発生時こそ目立ってしまい非難のある環境では非難されてしまうため、通常時から仕事を評価することで開放性を確保する必要がある。
- **双方向の学習** 指名運用エンジニアにトラブル時の知見や対策を意見してもらうことで、問題意識の価値を学習することができる。指名運用エンジニアの理解が理解されると、チーム間の境界が弱まり、顔の見えるエンジニアが増え信頼性が増す。

##### 9.5.2.2 ブートキャンプとローテーション
**ブートキャンプ**はチームに配属されたメンバーを、まず他チーム等で仕事をさせることで、他チームの仕事などを理解をさせることである。 **ローテーション**は配属当初以外の時期に行われる。ほかのチームメンバーと仕事をすることで、共感と理解の基礎を作り、堅固な集団を作り出すことが出来る。

##### 9.5.2.3 その他のローテーションの形
これらの共感作成手法は、協力関係の作成のみならず企業や業界の文化形成の作成と維持に有用である。特に運用分野は日の光が当たらないことが多く、苦労や努力が理解されないことが多い。
**サポートローテーション**は他チームのメンバーが顧客サポートにまわり、サポート業務を理解しつつ負担を減少させる方法である。 **エンジニア交換**は異なる企業間でエンジニアを交換することである。企業の秘密を守ることより、ソフトウェアや働き方のオープンソース化によって業界全体を強化し、知識や経験を共有交換することができる。(ただしこれらの交換は双方向的な共有が必要である他、コモンズの悲劇を引き起こす非協力的組織が居てはならない)。

チームの共感を築くことに注力する組織は、異なるチームや、コストセンター（企業経営のために金銭的コストを増やす存在：ITサポートなど）への理解を促進させ、コストセンターへの適切な評価と支援を行うことで大きな成果を生み出すことができる。

devopsでは組織構造は上下関係の「はしご」ではなく、「ロープピラミッド」である(p130 Fig9-1)。はしごでは下が無くなっても機能するが、ロープピラミッドは基礎が堅固でないと機能しない。

#### 9.5.3 チームのコミュニケーションの改善
共同作業には効果的なコミュニケーションが不可欠である。コミュニケーション手段には即時性、オーディエンスへの浸透度、コンテキスト、その他要素に対して向き不向きがある。メールやチャットツールの様に履歴が残り、かつ自分でカスタマイズできるツールは、情報の整理を適切に行うことが出来る。これらのツール選択のオプションは少ないより多すぎる方が良い。

##### 9.5.3.1 危機状況下でのコミュニケーション
危機的状況ではコミュニケーションが揺らぎやすい。以下に危機的状況下におけるコミュニケーションテクニックを紹介する。
###### 職業横断的なコミュニケーション
通常時から横断的なコミュニケーションを行い、指名運用エンジニアなどを活用することで、危機的状況下でも横断的なコミュニケーションがスムーズに行われる。また、危機的状況に用いるチェックリストなどのテンプレートを共通標準として設定することで問題や摩擦を軽減できる。
###### 断定的なコミュニケーション
危機的状況下では余裕のあるコミュニケーションができないことが多い。非難のない文化や非言語的なコミュニケーションに精通することが大事だ。
###### 危機状況下のコミュニケーションテクニック
**Two Challenge Rule**は疑問に思う事を２度まで言うというルールである。危機的状況では１度だと見過ごされるが、多く疑問を呈しすぎると議論や対立になり、適切な対応が出来なくなる場合がある。

**CUS**は疑問を感じたときにそれを伝えるための基準である。
- Concerned：何か気にかかるとき
- Unsure：はっきりしないとき
- Safety：安全が脅かされているとき

**SBAR**は懸念や批判を生産的に表明するための指標である。表明するためには以下を含む必要がある。
- Situational：状況説明
...
ティナ・ドンベックは米国特許商標庁(USPTO)の自動化担当ディレクターであり、政府組織でdevops改革を実行している。彼女の働くCIO室は顧客である職員が使う技術とツールの動作を担保し、業務を円滑に進められるようにしている。

#### 9.6.1 背景と方向性
> ドンベックにとってdevopsとは、技術的な面では効果的かつ効率的に継続的デリバリーを行いつつ、文化的な面では品質の高い製品を作るために、信頼と協調の精神のもとで複数のチームを協力させることである(p.134)

ドンベックはCIOでCDプラットフォームの開発・実装・運用を行っている。ここではベンダーに縛られないオープンソースのツールを用いている。これらのツールはユーザーコミュニティが充実しており、質問への回答のほか、常に新しい機能などが提供されている。

#### 9.6.2 コラボレーションとアフィニティの奨励
ドンベックの考えるコラボレーションと協調は以下のようなものだ：
- 共通の目標に向かって仕事をすること
- コラボレーションが開放的であること
- 自分のテリトリーを確保する必要がないこと
- 非難文化が無く、失敗を恐れる必要がないこと

ドンベックはdevopsワークスペースのチームを設置し、メンバーの共同作業を行う場を提供した。このようなスペースでは、共通の目標のために議論し、安心して異論をぶつけあうこともできる。

#### 9.6.3 複数の視点のバランスを取る
devopsは人によって全く異なる理解をされている場合がある。組織の人やチームが別の方向を向いている他、スケジュールの感覚の差異なども生じることがある。このような場合、違いを認めて、共通の成功基準を統一的に定義して、後の詳細は各チームに定義することが有効である。

大きい組織であればあるほど、共通の理解や合意を得るための時間は必要になる。しかし、着実な前進と努力が重要なる。
...
#### 9.8.3 スペース
オフィスに休憩スペースことは、創造や問題解決のインフラとなり、コラボレーションを促進する。また、手持ちの仕事から離れて精神的な休息も得られる。休憩スペースを設置する際はそのスペースが他チームを犠牲にするようなことの無いよう注意すべきでもある。
...
#### 9.9.2 チーム間の交渉
トラブルチケットが複数チームを経ているようなら、そのチケットを見ることでどのような仕事が行われているか追跡できる。このような履歴はチーム間のアフィニティを間接的に計測する手段となりうる。

また、チーム間で共通したソフトウェアを用いると、アフィニティの計測が楽になる。プロジェクトに関わるチーム数、時間配分、リソース配分、そして誤解や問題の発生などを追跡することで、チームを跨ぐ仕事に対するアフィニティを見ることが出来る。

#### 9.9.3 コミュニティへの返礼

devopsが広まった理由の一つにコミュニティによる意識や知識の共有がある。ここでは成功のみならず失敗や苦労についても共有される。オープンソースのコードや、カンファレンスでの公演、また、コミュニティへの多様な貢献は「精神の寛大さ」によってもたらされており、その寛大さにより助けを得た人もまた、同様なことをしてコミュニティに貢献する。

このような考え方には、グループを犠牲にして自分の利益だけを追求する利己的な人間にペナルティを与える考えが必要となる。精神の寛大さはコミュニティをリードするが、利己的な人間ばかりになると業界全体に対して大きな損失となるのだ。

### 9.10 Sparkle CorpのDevとOpsのアフィニティ
MongoDBを使うにあたってプロジェクトマネージャーのヘドウィグは評価とプロトタイプ開発に時間を費やすことを許可した。一方ジョージはMongoDBに対して経験が無いため、開発には慎重姿勢を取った。結果として、大佐はこれらの評価を公表することにし、情報収集を重ねて両チームが更なる意見交換を行えるよう決定した。
