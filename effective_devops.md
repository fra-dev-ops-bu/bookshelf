...
リーンとは「痩せた」を意味する言葉、すなわち無駄を取り除くということにつながる。要所要所に存在する不要な仕事や、遠回りな手法を１つずつ改善し、そぎ落としていくことで、よりリーンな仕事を導き出すことが出来る。
...
#### 4.5.2 クラウドコンピューティング
- インターネットを経由してコンピューター機能や処理能力をサービスとして受けるインフラ
- 柔軟かつ利便性があり、統一した環境での作業を行うことが可能
- devopsの文化と親和性が高い
  - 自分にとって効果的なものを用いて開発するdevopsにとってクラウドコンピューティングは **必須ではない** 。
- 例：AmazonAWS, Google Apps, Microsoft Azureなど
