...
【誤解1】 古くからのシステム管理者に新しい手法は教えられない
【真実1】**必要な時間とリソースを用いて学習すれば、学べないということは決してない。**

- 新しいスキルを持たない人が不必要ということではない
- 大規模なシステムほど、従来からのスキルが必要であり、すぐに消えて無くなりはしない。

【誤解2】急成長したいときはロックスターを採用しなければいけない
【真実2】**急成長のために技術的な能力以外に目をつむることは近視眼的だ。**
- その様な一部の人間が企業のトーンを決めてしまう
- 同類の人が集まり、必要な人を採用できなくなる

【誤解3】多様性に満ちたチームは効果的にコラボレーションできない
【真実3】**多様性を受け入れられない環境は、それ自体がそもそも不適切なことが多い。**
- 同質的な環境での性差別や人種差別、ジョークなどはそもそも不適切
- 多様性の高いチームは短期的には対立が増える
- 長期的には創造性や問題解決能力が向上する
- メンバーが協調的になることを学習する
...
- 職務と責任を明確にする。
- 人に対する期待に対してすれ違いや誤解を解く
- トレーニングや教育が必要な場合はリソースや時間を提供する
- 仕事の調整をしてワークロードを偏らせない
...
社員と別の道を歩む必要があるなら、それは否定的なことではない。しかし、パフォーマンスを理由にポジションから外すのであれば、長期間のトレーニングや改善計画を与える必要がある。トレーニングにはメンターシップを用意し、成功する見込みを向上させる必要がある。

価値や目標のずれが一致していない場合、管理職やメンターとのフィードバックを行いずれを確認する必要がある。その方向性の変化を受け入れられない場合、良い条件で早い時期に辞められるようにするほうが、問題を抱えるより良い。
...
#### 8.2.4 チームの中に軽く見られていると感じている人がいる

多様性のある職場でも、チーム内で軽く見られている人たちが出てきてしまうことがある。研究では、女性の提案は同僚の男性より軽く見られることが多いことが明らかとなっている。多様性のあるチームの構築には投資が必要不可欠である。また、模範的な行動をトップダウンで示し、ハラスメントなどの問題に対してのトレーニングや教育を推奨・義務化する必要がある。

ハラスメントや軽視の問題を解決することは文化の形成に貢献する一方、問題を見逃すことは、ハラスメントなどを容認してしまい、この企業では安心して働けないという明確なメッセージを送ることに他ならない。信頼を失う前に、その問題を排除する方がはるかに簡単な方法だ。
...
また、人のせいのみではなく、自らが気づいていなかった自身の問題点がある場合も考慮すべきである。成熟したエンジニアであれば、内省と自分に対する率直な評価が大事だ。

#### 8.2.8 （もう）誰も私のいう事を聞いてくれない

> どのように状況を改善するかは、直接の上司からどれくらい支援してもらえるかによって変わる(p.101)

企業の成長や再編などにより、自分の意見が聞き取られにくくなることがある。特定の個人が耳を傾けないなら、個人間の対立や、自らの過ちが原因かもしれない。上司が耳を傾けないなら、直接本人と話すほか、更に上と対話する必要がある。それでも話を聞いてくれないならば、内外で新しいオプションを探すことも選択肢のひとつだ。
...
> 最終的にはどこでなぜ働くかを意識手に気選択する必要がある。（高給）だけを目的にすると、ストレスが溜まって健康を害するという代償を払うことになる(p.103)
