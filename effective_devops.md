...
2. 専門家チームを作ると却って悪化する。devopsは誰かの役割ではない。大事なのはdevopsの「心持ち」を理解し実践すること。
3. 否。devopsエンジニア = スーパーエンジニア は誤り。大事なのは「組織全体」がこの運動の本質を理解し、企業に適用してみること。
4. 
5. 
6. 
7. 
...
上記のアンチパターンの簡潔な説明を下記に列挙する。:construction:
```
1. 
2. 
3. 
