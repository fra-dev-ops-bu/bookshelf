...
gantt
    ...
    section 発展期
    グローバルなコミュニティの始まり :done, des3, 1961,1980
    ネットワークの時代               : des1, 1979,2020
    アプリケーションとウェブの時代   : des5, 1995,2020

    section 成熟期
    ソフトウェア開発手法の発展                           : des1, 2001,2020
    オープンソースソフトウェアとプロプライエタリサービス : des1, 2006,2020
    アジャイルインフラストラクチャ                       : des1, 2008,2020
    DevOpsDaysの始まり                                   :active, des1, 2009,2020
