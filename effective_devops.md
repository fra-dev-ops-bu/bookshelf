...
#### 9.5.1 競争から協調へ
協力的な職場環境の構築と維持は、チームが競争関係から協力し合う関係へ移るために重要である。
##### ゲーム理論による説明
公平な競争は創造性を高め、顧客に選択肢を与えながら自由市場を構築する。競争の激化は**コモンズの悲劇** を誘発し、個人が利益のために独立して行動することで共有リソースを枯渇させ、全体の利益を低下せる。

協力的なコミュニティの構築には、オストロムの理論(p.124参照）を確保する必要がある。適切な制裁行動は一部の非難されるべき行動を抑制し、コミュニティを公正なものへと動かす。

#### 9.5.2 チームの共感を築く
> devops運動の重要な教義のひとつは、壁の向こうにいる人たち、つまり企業の別の部門の人たちに対する共感だけでなく、顧客に対する共感も育てることである。(p.125)

##### 9.5.2.1 指名運用エンジニア
サイロ化環境では、チーム間のサポートやサービスの提供が困難である。他チームのための**担当運用エンジニア**を指定することで、チーム間の繋がりを構築することが出来る。指名されたエンジニアが他チームとの連携を行うことで、説明や感覚の引継ぎを行う必要が無く、開発や運用もスムーズになる。
...
**ブートキャンプ** はチームに配属されたメンバーを、**ローテーション** は配属当初以外の時期に、他チーム等で仕事をさせることである。他チームメンバーと仕事をすることで、共感と理解の基礎を作り、堅固な集団を作り出すことができる。

##### 9.5.2.3 その他のローテーションの形
**サポートローテーション**は他チームのメンバーが顧客サポートにまわり、苦労や努力が理解されないサポート業務を理解しつつ負担を減少させる方法である。 **エンジニア交換**は異なる企業間でエンジニアを交換することである。

企業の秘密を守ることより、ソフトウェアや働き方のオープンソース化によって業界全体を強化し、知識や経験を共有交換することができる。(ただしこれらの交換は双方向的な共有が必要である他、コモンズの悲劇を引き起こす非協力的組織が居てはならない)。

#### 9.5.3 チームのコミュニケーションの改善
共同作業には効果的なコミュニケーションが不可欠である。コミュニケーションツールには即時性、オーディエンスへの浸透度、コンテキスト、その他要素に対して向き不向きがある。メールやチャットなど、ツール選択のオプションは少ないより多すぎる方が良い。

##### 9.5.3.1 危機状況下でのコミュニケーション
危機的状況ではコミュニケーションが揺らぎやすい。以下に危機的状況下におけるコミュニケーションテクニックを紹介する。

###### 職業横断的なコミュニケーション
通常時から横断的なコミュニケーションを行い、指名運用エンジニアなどを活用することで、危機的状況下でも横断的なコミュニケーションがスムーズに行われる。危機的状況に用いるチェックリストなどのテンプレートを共通標準として設定することで問題や摩擦を軽減できる。
###### 断定的なコミュニケーション
危機的状況下では余裕のあるコミュニケーションができないことが多い。非難のない文化や非言語的なコミュニケーションに精通することが大事となる。
###### 危機状況下のコミュニケーションテクニック
**Two Challenge Rule**は疑問に思う事を２度まで言うというルールである。危機的状況では１度の疑問提起は見過ごされがちだ。しかし、多く疑問を呈しすぎると議論や対立になり、適切な対応が出来なくなる場合がある。
...
> **【あらすじ】**
>アリスとジョーディーがMongoDBとMySQLを比較するマシンを提示。

MongoDBを使うにあたってプロジェクトマネージャーのヘドウィグは評価とプロトタイプ開発を許可した。一方ジョージはMongoDBに対して不慣れなため、開発には慎重姿勢を取った。大佐はこれらの評価を公表し、情報収集を重ねて両チームが更なる意見交換を行えるよう決定した。


## 第10章 アフィニティ: 誤解と問題解決
この章では、4本柱の2本目、アフィニティ (親近感, 一体感) について詳細を見ていく。
アフィニティに関する誤解や問題は、個人的なコラボレーションやコミュニケーションにおける誤解や問題に似ているが、より高度で組織的なものという点が異なる。

### 10.1 アフィニティの誤解
当たり前だが、組織の中での責任や貢献、devops実践現場でのアフィニティや共有の重要性、へのイメージは人それぞれである。

#### 10.1.1 運用エンジニアは企業にとって開発者ほど役に立たない
それは誤解だ。ただし、組織にとって一部のチームが他のチームよりも価値がある、という考え方に陥ることも理解できる。
この原因の一つは、各チームの仕事が周りにどれだけ見えているかに差があるためだ。

#### 10.1.2 外部と共有しすぎると競争優位が弱まる
それも誤解だ。devopsは、エンジニアが直面している問題を互いに話し合い、その問題解決の方法を見つけようとして始まった運動である。
例えばDevopsDaysカンファレンスで講演するとしても、その内容は製品自体のことではなく、その製品をどのように作り、サポートしているかを話しているだけだ。

### 10.2 アフィニティの問題解決
以下の項では、よくある問題への解決ヒントを示す。

#### 10.2.1 ひとりまたは複数の個人がグループフローを妨害する
- 支配的あるいは傲慢といった破壊的な言動を通じてグループフローを壊す人が現れる場合がある。
- 破壊的な言動は、グループフローに影響を与えるだけでなく、ストレスや不満の原因となり、チームメンバーが退職する原因にもなりかねない。

**ヒント**
- その人が破壊的な言動を行う理由を理解するところから始める。よくある理由としては力関係、やり場のない不満、対立など。
- 改善の第一歩は、破壊的な言動をするとどのような責任を取らなければいけないのかをはっきりさせて、そのような行動の撲滅のために組織が本気で取り組んでいることを示すこと。
- 組織としては、許容できる言動と許容できない言動を明確に示す行動規範を整備するとよい。また、問題のある言動をマネジメントするプロセスを作るのも良い。
- なお、規範に対する違反が起きた時には、個人ではなく、行動に焦点を当てるべき。個人への非難文化を無くしていこう。

#### 10.2.2 あるチームが別のチームの仕事を止めてしまう
**ヒント**
- 原因の調査から始める。
- 原因としては以下のものがよく見られる。
    - あるチームの仕事のペースが遅いから: 抱えている仕事の量に対して人手が足りていないのでは？
    - 互いに相手の抱える問題、プロジェクトの内容、要件を理解できていないから: チーム間のコミュニケーションが不足しているのでは？仕事のコンテキストや優先順位は共有されていますか？
    - 企業の方針、コンプライアンス問題、技術的な能力不足から: これらの理由はすぐに明らかにならない場合も多い。お国柄も関係する。
    - 競争を重視する空気から: 協調よりも予算や人員などのリソースをチーム間で奪い合うような組織ではないですか？全社的に対策を講じる必要がある。
- 問題の多くは、直接的なコミュニケーションによって大きく改善される。
    - ただし、そうしたコミュニケーションの場には適切な態度で臨まなければならない。
    - 例えば、誰かがわざと自分の邪魔になるように仕事をしていると（心の底で）感じている場合、自分の言動がそのような思い込みを反映したものになってしまう。
    - また、質問されることが多すぎるとか、自分がしている仕事が尊重されていないと感じている人たちは自己防衛的になりがちである。
    - これらはどちらも、機能不全のサイクルや受動攻撃的な言動を育てる土壌になる。
- 状況や全員の期待を評価し直すために、オープンかつ直接的なコミュニケーションをするよう努力しよう。
...
**正解: 成功している組織のツールを真似ても同じ結果が得られるとは限らない。結果ではなくプロセスに重点を置く必要あり。**

特定のツールを廃止する前に、従来のツールの意味を認めどのような変更が必要とされているのか、今までなぜ使われていたのかを理解することが重要だ。

#### 誤解2: 技術Xを使っているので、うちはdevopsを実践している
**正解: どのようなツールでも、特定のツールや技術だけで問題のある文化を変えることはできない。**

DevOpsの取り組みのためには、ツールがなぜ役に立つのかを理解する必要がある。devopsの取り組みに重要なのは、特定のツールの有無ではなく、なぜそのツールが文化を支えたり阻害したりしているかを理解することだ。devopsと関連して取り上げられるツールを導入しても、あくまで共同作業の方法のひとつでしかないため、devopsを実践していることにはならない。

#### 誤解3: 間違ったツールを選ばない様に注意しなければならない
**正解: ツールの細部ではなく、そのツールの使い方のPros/Consについて注意を払うべし。**

ツールの適切な使用法・定着方法の原則を理解し、新しいツールや技術の導入に柔軟になることが重要だ。もしも最適でないツールを選んだ場合、その対処へのリソース必要量が減少する。

#### 誤解4: devopsツール全部入りセットやdevops-as-a-serviceを買ってくればよい
**正解: devopsは単なるツールの話ではない。devopsは文化活動であり、サービスとして購入するものではない。**

devopsを売りにするツールを導入するときは、4本柱を基に、そのツールがチームに対してどのように機能するかを理解していく必要がある。

### 13.2 ツールの問題解決
ツールの選定は、問題解決のために役立つという理由が重要だ。本節では3つの問題の解決方法を紹介する。

#### 問題1: 技術Xのベストプラクティスを見つけようと努力している
問題解決前に、以下の事を行い解決の選択肢を比較し選択していくことが重要である。
- 問題の現在の状態をつかむ
- 必須のものと、あれば便利なものを明確に分ける
- 重要な情報を持っている個人やチームを明らかにして、彼らの力を借りて問題を評価する

問題解決における意思決定のプロセスのドキュメント化は、意識的な決定プロセスを明確にし、透明性を確保することができる。注目したこと、問題点、ifプランなどをドキュメントに含めることで、予想外の問題にも頑健なソリューションを導き出せる。

#### 問題2: ひとつのツールにする合意が得られない
チームの規模にかかわらず、全員一致の合意は簡単には得られない。ツールの統一や選択には以下を検討することが有効である。
- 各ツールのユーザーを集めてテストグループの作成
- ツール使用者の特徴の把握
- ソリューション候補のベータテスト
- 現在のツールの問題と頻度

コンプライアンスが重視される仕事には、お硬いツールを確立したほうがよい場合もある。そのような強制は最小限に抑えたいが、意味がある分野も存在している。

>水研の場合は情報漏洩の問題からフリーのサービスや海外サーバーのサービスなどの導入に慎重だ。柔軟に採用できるところは採用していきたい。

#### 問題3:  技術Xの採用（または廃止）を決めたが、社員がそれに抵抗している
新ツール選択のプロセスは、ツール導入への賛同に影響する。持続可能で有益な変更を生み出すためには、コミュニケーションと共感が大きな意味を持つ。そのためには、以下のを行うことが重要である。
- ツール使用者のフィードバックの取得
- 変更や展開についての情報を共有とチームの協力
- 余裕のある変更スケジュール
