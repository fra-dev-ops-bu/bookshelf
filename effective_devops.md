...
- 人の結びつきは「強・弱・無」の３種類
- **強い結びつき**はチーム内の人間関係など
- **弱い結びつき**は、たまに話す程度か、知り合いの様な人間関係
- **弱い結びつき**は育てることで大きな利益を生じる可能性がある
...
#### 9.3.2 アフィニティの定義
アフィニティは、人間を理解し、様々なチームや組織と教護な信頼関係を構築することである。また、アフィニティは個人、チーム、部門、企業間の関係の強さの尺度となるほか、社会的触媒として作用する。devops共同体の維持のためには、効果的な協力の実現が重要となる。
...
安定した関係を結べる相手の上限は150人程度（ダンバー数と呼ばれる）であるため、それ以上の人数が集団に所属すると、規則や法律などの規範が必要となる。大きな組織では文化的プラクティスを通して社会構造を構築する必要がある。個人間、グループ間の関係を重視できない場合、不必要な競争や排他的な行動を導く。
