...
- 対処方法は、その人が破壊的な言動を行う理由を理解するところから始まる。よくある理由としては力関係、やり場のない不満、対立など。
...
まずはこの問題を引き起こす原因の調査が必要である。原因としては以下のものがよく見られる。
...
**以上の問題の多くは、直接的なコミュニケーションによって大きく改善される。** 
