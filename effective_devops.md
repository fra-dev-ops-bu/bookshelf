...
- 競争の激化は**コモンズの悲劇** を誘発する。
  - 個人が利益のために独立して行動することで共有リソースを枯渇させ、全体の利益を低下せる。
- **E.オストロム**はコモンズシナリオの成功を導く要素を以下の様に定義した：
  - 集団全体の成因をコントロールする手段
  - 社会ネットワーク
  - 参加するすべての人の行動の観察可能性
  - 個人に対する段階的な制裁
...
協力的なコミュニティの構築には、オストロムの理論を確保する必要がある。適切な制裁行動は一部の非難されるべき行動を抑制し、コミュニティを公正なものへと動かす。

>スタートアップや急激に業績が悪化し縮小している会社などはリソースの変化が激しくなりうる場合があるため、非協力的な行動を誘発しやすい。
...
**サポートローテーション**は他チームのメンバーが顧客サポートにまわり、苦労や努力が理解されないサポート業務を理解しつつ負担を減少させる方法である。 **エンジニア交換**は異なる企業間でエンジニアを交換することである。企業の秘密を守ることより、ソフトウェアや働き方のオープンソース化によって業界全体を強化し、知識や経験を共有交換することができる。(ただしこれらの交換は双方向的な共有が必要である他、コモンズの悲劇を引き起こす非協力的組織が居てはならない)。
